...
class ImageS3ServiceTest extends TotalTestSupport {
    ...
    void testUploadImageToS3() throws IOException {
        ...
        //when
        MemberFile memberFile = sut.createMemberFile(mockImage, fileOrder, memberId);
    ...
    void createMemberFileEntityException1() {
        ...
        //when & then
        Assertions.assertThatThrownBy(() -> sut.createMemberFile(mockFile, 0, 1L))
    ...
    void createMemberFileEntityException2() {
        ...
        //when & then
        Assertions.assertThatThrownBy(() -> sut.createMemberFile(mockImage, 0, null))
                .isInstanceOf(MemberApplicationException.class)
    ...
    void createMemberFileEntityException3() {
        ...
        //when & then
        Assertions.assertThatThrownBy(() -> sut.createMemberFile(null, fileOrder, memberId))
                .isInstanceOf(MemberApplicationException.class)
