...
@DisplayName("[단위] 이메일 중복체크 요청 request dto 테스트")
class EmailAvailableRequestDtoTest {
    ...
    void validData() {
        ...
        //when
        Set<ConstraintViolation<EmailAvailableRequestDto>> violations = validator.validate(dto);
    ...
    void nullEmail() {
        //given
        EmailAvailableRequestDto dto = EmailAvailableRequestDto.of(null);
