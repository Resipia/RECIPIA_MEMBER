...
VALUES ('test1@example.com', 'password1', 'Full Name 1', 'Nickname1', 'ACTIVE', 'Introduction 1', '010-1234-5678',
        'Address 1-1', 'Address 1-2', 'Y', 'Y', 'MEMBER', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('test2@example.com', 'password2', 'Full Name 2', 'Nickname2', 'ACTIVE', 'Introduction 2', '010-2345-6789',
        'Address 2-1', 'Address 2-2', 'Y', 'Y', 'MEMBER', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('test3@example.com', 'password3', 'Full Name 3', 'Nickname3', 'ACTIVE', 'Introduction 3', '010-3456-7890',
